...
const TicketsListCustom = (props) => {
  ...
  useEffect(() => {
    ...
    const ticketMatchesStatus = (ticket) => {
      ...
      if (status === "open") return ["open", "pending"].includes(ticket.status);
    ...
    socket.on(`company-${companyId}-ticket`, (data) => {
      ...
      if (data.action === "update" && shouldUpdateTicket(data.ticket) && ticketMatchesStatus(data.ticket)) {
        dispatch({
          type: "UPDATE_TICKET",
          payload: data.ticket,
        });
    ...
    socket.on(`company-${companyId}-appMessage`, (data) => {
      ...
      if (data.action === "create" && shouldUpdateTicket(data.ticket) && ticketMatchesStatus(data.ticket)) {
        dispatch({

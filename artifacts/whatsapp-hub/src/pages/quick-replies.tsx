      ...
      <div className="max-w-3xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-sm p-4 mb-4 space-y-3">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Paperclip className="w-4 h-4" /> Adjuntar imagen/video/audio
            </label>
                  ...
                  {r.attachments.map((a) => (
                    <div key={a.id} className="relative group">
                      {a.kind === "image" ? (
                        ...
                        <div className="w-20 h-20 rounded-md border bg-[#f0f2f5] flex items-center justify-center text-xs text-center p-1">
                          {a.fileName}
                        </div>
                      )}
                      <button

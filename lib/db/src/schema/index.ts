...
export const usersTable = pgTable("users", {
  ...
  labelColor: text("label_color").notNull().default("#00a884"),
...
export const chatsTable = pgTable(
  "chats",
  {
    ...
    phoneCodeVerified: boolean("phone_code_verified").notNull().default(false),
    phoneCodeSource: text("phone_code_source"),
  ...
  (t) => ({
    ...
    assignedUserIdx: index("chats_assigned_user_idx").on(t.assignedUserId, t.assignedAt),
  }),
);
...
export const internalMessagesTable = pgTable(
  ...
  (t) => ({
    senderRecipientCreatedIdx: index("internal_messages_sender_recipient_created_idx").on(
      t.senderUserId,
      t.recipientUserId,
      t.createdAt,
    ),
    recipientReadIdx: index("internal_messages_recipient_read_idx").on(t.recipientUserId, t.readAt),
  }),
);

export type InternalMessage = typeof internalMessagesTable.$inferSelect;
export type InsertInternalMessage = typeof internalMessagesTable.$inferInsert;
